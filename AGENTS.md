...
| P6 | `/guided-goal` interview uses the ask tool | upstream PR [#8187](https://github.com/can1357/oh-my-pi/pull/8187), closed unmerged | retain until upstream provides the behavior |
